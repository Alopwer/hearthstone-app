...
const Filterbar = props => {
  ...
  const {cardTypes, classes, rarities, minionTypes, keywords} = props.metadata
  return (
    <div>
      <div>
        <SetsContainer />
        {withSelectFilter({ value: classValue, setValue: props.setClass, options: classes })(SimpleFilter)}
        <ManaCostContainer />
        <SearchContainer />
      ...
      </div>
      {
        ...
        <div>
          ...
          {withSelectFilter({ value: type, setValue: props.setCardType, name: 'Type', options: cardTypes })(SimpleFilter)}
